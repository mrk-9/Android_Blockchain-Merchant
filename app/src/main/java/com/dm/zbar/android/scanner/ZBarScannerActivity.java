...
//		if (ContextCompat.checkSelfPermission(ZBarScannerActivity.this, Manifest.permission.CAMERA) == PackageManager.PERMISSION_DENIED) {
//			int requestCode = 0;
//			ActivityCompat.requestPermissions(ZBarScannerActivity.this, new String[]{Manifest.permission.CAMERA}, requestCode);
//		}
